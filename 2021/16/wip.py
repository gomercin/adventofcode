...
class Package:
    def __init__(self, ci, bits):
        ...
        ci+=3
        self.typeid = int(bits[ci: ci+3], 2)
        ci+=3
    ...
    def calculate(self):
        if self.typeid == 0:
            ...
            # greater than, return 0 if first value greater than second, else 0
            if self.subpackages[0].calculate() > self.subpackages[1].calculate():
                return 1
            else:
                return 0
        elif self.typeid == 6:
